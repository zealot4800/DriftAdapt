...
from stimulation.src.pipeline import CaravanPipeline
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run the minimal CARAVAN baseline")
    ...
    _, summary = CaravanPipeline(config, config_path).run()
    labels = {
