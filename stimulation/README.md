# Minimal CARAVAN baseline

This directory is a compact implementation of the CARAVAN online-learning
...
feature order, strict binary-label schema, batching, validation, and CARAVAN
...
For each window, CARAVAN compares the current student's predictions with labels
...
100-flow window, workload 2 begins at window 71. CARAVAN does not receive that
...
are not used by the trigger or CARAVAN training.

## Provenance and scope

Reference: [Per-Packet-AI/Caravan-Artifact-OSDI24](https://github.com/Per-Packet-AI/Caravan-Artifact-OSDI24).
